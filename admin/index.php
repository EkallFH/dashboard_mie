        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Admin -->
                    <h2 class=" ml-2 mb-0 text-black-600"> Hello Ming </h2>
                </nav>
                <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Dashboard Warung</h1>
                    </div>
                    <!-- Status Card -->
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <div class="card">
                                <div class="card-header bg-warning text-white">
                                    <h6 class="pt-2"><i class="fas fa-cubes"></i> Jumlah Menu Saat Ini</h6>
                                </div>
                                <div class="card-body">
                                    <center>
                                        <h1><?php echo $banyak_menu; ?></h1>
                                    </center>
                                </div>
                                <div class="card-footer">
                                    <a href='menu.php' class="text-dark"> Data Menu <i
